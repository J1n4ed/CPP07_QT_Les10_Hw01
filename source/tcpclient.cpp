...
{
    qDebug() << "DEBUG: in TCPclient::TCPclient";
...
{
    qDebug() << "DEBUG: in TCPclient::SendRequest";

    QByteArray sendHeader;
    QDataStream outStream(&sendHeader, QIODevice::WriteOnly);

    outStream << head;

    socket->write(sendHeader);
}
...
{
    qDebug() << "DEBUG: in TCPclient::SendData";
...
{
    qDebug() << "DEBUG: in TCPclient::ConnectToHost";
...
{
    qDebug() << "DEBUG: in TCPclient::DisconnectFromHost";
...
{
    qDebug() << "DEBUG: in TCPclient::ReadyReed";
...
{
    qDebug() << "DEBUG: in TCPclient::ProcessingData";
...
*/
        ...
        qDebug() << "DEBUG: in CLEAR_DATA case";
